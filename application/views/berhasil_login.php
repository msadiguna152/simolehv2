<div class="osahan-account">
	...
	<div class="p-4 profile text-center border-bottom">
		...
		<p class="small text-muted">Email : <?= $this->session->userdata('email'); ?> | No. Telepon
			: <?= $this->session->userdata('no_telpon'); ?></p>
		<a href="<?= base_url(); ?>akun/edit" class="btn btn-primary btn-sm"><i class="icofont-pencil-alt-5"></i> Ubah
			Profil</a>
		<a onclick="return confirm('Apa Anda Yakin?')" href="<?= base_url(); ?>akun/logout"
		   class="btn btn-danger btn-sm"><i class="icofont-exit"></i> Logout</a>
	</div>
</div>
