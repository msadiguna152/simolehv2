      <div class="osahan-signin">
         ...
         <div class="p-3">
            ...
            <form method="POST" action="<?php echo site_url()?>akun/insert" onsubmit="return formValidasi()">
               ...
               <div class="form-group">
                  <label for="no_telpon">Nomor HP/Whatsapp</label>
                  <input type="text" name="no_telpon" class="form-control" placeholder="Masukan Nomor HP/Whatsapp..." required="">
               </div>
               <div class="form-group">
               ...
               <button type="submit" class="btn btn-primary btn-md rounded btn-block">Daftar</button>
            </form>
         </div>
      </div>
