        ...
        <div class="row">
          ...
          <div class="col-md-12 connectedSortable">
            ...
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <form role="form" action="<?php echo site_url('page/admin/Pendaftar/update')?>" method="post" id="quickForm">
                <div class="row">
                  <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="" name="dokumen" placeholder="Masukan File..." value="<?php echo $dokumen; ?>" required="">
                          <label for="dokumen">Download : <a href=""><?php echo $dokumen; ?></a></label>
                        </div>
