                  ...
                  <div class="col-md-6">
                        ...
                        <div class="form-group">
                          ...
                          <select class="form-control select2bs4" style="width: 100%;" id="" name="jenis_sosmed" data-placeholder="Pilih Jenis Sosial Media" required="">
                            ...
                            <option <?php if ($jenis_sosmed=="WhatsApp") { echo 'selected=""';}?>value="WhatsApp">Twitter</option>
                            <option <?php if ($jenis_sosmed=="G-mail") { echo 'selected=""';}?>value="G-mail">G-mail</option>
                          </select>
                        </div>
                  </div>
                </div>
