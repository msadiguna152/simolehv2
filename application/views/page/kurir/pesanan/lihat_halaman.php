		...
		<div class="container-fluid">
			...
			<div class="row">
					...
					<div class="card">
						...
						<div class="card-body">
							<form role="form" enctype="multipart/form-data"
								  action="<?php echo site_url('page/admin/pembeli/update') ?>" method="post"
								  id="quickForm">
								<div class="row">
									<div class="col-md-12">
										...
										<div class="form-group">
											...
											<input type="text" hidden="" name="id_pembeli" required=""
												   value="<?= $id_pembeli; ?>">
										</div>
				...
				<div class="col-md-8 connectedSortable">
					...
					<a href="<?php echo site_url('page/kurir/pesanan/peta?id=' . $this->input->get('id') . '&token=' . $this->input->get('token')) ?>"
					   class="btn btn-primary mt-2 btn-block"> <i class="fas fa-map-signs"></i>&nbsp;Peta Lokasi Tujuan</a>
					<!-- /.card -->
				</div>
				<!-- /.col -->
			</div>
