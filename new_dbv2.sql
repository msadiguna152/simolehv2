...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 24, 2020 at 12:17 AM
...
INSERT INTO `tb_pengaturan` (`id_pengaturan`, `nama_bisnis`, `no_wa`, `alamat_toko`, `kota`, `provinsi`, `latitude`, `longitude`, `tipe_ongkir`, `harga_ongkir_flat`, `harga_ongkir_perkm`, `google_api_key`, `icon`) VALUES
(1, 'Testing Nama Aplikasi', '6285245462842', 'Jln. Bina Bersama RT.01 RW.02 Desa Sarikandi Kecamatan Kurau', 'Tanah Laut', 'Kalimantan Selatan', '-3.799686', '114.746696', 2, '2000', '3000', '1234456', 'aa5E5Cyybn.jpg');
...
(3, 'Adiguna Kurir v2', 'logo_d.png', '3', '3', 'msadiguna152@gmail.com', '1234', 'Kurir'),
...
(39, 10, NULL, '18290', '2020-10-22 10:00:39', 'Pemesanan', 4290, '0', 'Yang enak ya anunya?						'),
(40, 10, NULL, '18290', '2020-10-22 10:00:47', 'Pemesanan', 4290, '0', 'Yang enak ya anunya?						'),
(41, 10, NULL, '18290', '2020-10-22 10:00:58', 'Pemesanan', 4290, '0', 'Yang enak ya anunya?						'),
(42, 10, NULL, '48290', '2020-10-22 10:42:23', 'Pemesanan', 4290, '0', 'Yang enak ya anunya?						');
...
CREATE TABLE `tb_sliders` (
  ...
  `url_sliders` varchar(50) DEFAULT NULL,
...
(1, NULL, 'aa5E5Cyybn.jpg', 'test'),
(2, NULL, 'aa5E5Cyybn.jpg', 'Bagus1');
...
--
ALTER TABLE `tb_sliders`
  MODIFY `id_sliders` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
